<script setup>
import DataBasic from './DataBasic.vue'
import DataWaves from './DataWaves.vue'
import DataHR from './DataHR.vue'
import DataCamera from './DataCamera.vue'
import DataCognitive from './DataCognitive.vue'
import DataEmotionHistory from './DataEmotionHistory.vue'
import DataEmotion from './DataEmotion.vue'
import DataEEGTopography from './DataEEGTopography.vue'
